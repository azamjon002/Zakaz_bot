<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @endcan
        @can('yetkazib_berish_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.yetkazib-berishes.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/yetkazib-berishes") || request()->is("admin/yetkazib-berishes/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.yetkazibBerish.title') }}
                </a>
            </li>
        @endcan
        @can('contact_access')
